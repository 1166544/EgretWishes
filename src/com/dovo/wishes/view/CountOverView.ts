 ...
 *
 */
class CountOverView extends CountBaseView 
{
    /**
     * 得分总数
     */ 
    private _totalTxt: eui.Label;
    
    /**
     * 描述说明
     */ 
    private _descTxt: eui.Label;
     ...
     * 查看排名按钮
     */ 
    private _sortBtn: eui.Button;
    
    /**
     * 转发按钮
     */ 
    private _forwardBtn: eui.Button;
    
    /**
     * 求关注层
     */ 
    private _watchView: CountWatchView;
    ...
    public get totalTxt(): eui.Label { return this._totalTxt; }
        
    public get replayBtn(): eui.Button { return this._replayBtn; }
        
    public get sortBtn(): eui.Button { return this._sortBtn; }
        
    public get forwardBtn(): eui.Button { return this._forwardBtn; }
}
